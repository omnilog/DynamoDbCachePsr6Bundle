[![Tests](https://github.com/OmnilogSage/DynamoDbCachePsr6Bundle/workflows/Tests/badge.svg)](https://github.com/OmnilogSage/DynamoDbCachePsr6Bundle/actions?query=workflow%3ATests)
[![Coverage Status](https://coveralls.io/repos/github/OmnilogSage/DynamoDbCachePsr6Bundle/badge.svg?branch=master)](https://coveralls.io/github/OmnilogSage/DynamoDbCachePsr6Bundle?branch=master)
...
- `Omnilog\DynamoDbCacheBundle\Cache\DynamoDbCacheAdapter` - this one implements the Symfony `AdapterInterface` and
  `CacheInterface`
